...
def get_ts(w1=200E-9,w2=200E-9,w3=200E-9):
    ...
    circuit.V(3, 'input', 'V2' ,'pulse(-0.1 0.1 0 1p 1p 1e-2)') # PULSE ( V1 V2 TDelay TRising TFalling Width PERiod PHASE )  
...
if __name__=='__main__':
    ...
    #     w1=i*1e-9
    #     simulate(random.uniform(200e-9, 3000e-9), random.uniform(200e-9, 3000e-9), random.uniform(200e-9, 3000e-9))
    print(get_ts( 8000e-9, 2e-07, 4.560121343600643e-06))
